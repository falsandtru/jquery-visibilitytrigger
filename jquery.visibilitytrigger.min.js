...
(new Date).getTime();if(a.interval<=J-a.timestamp)a.timestamp=J;else return function(a,c,d){var e=setTimeout(function(){b(a.currentTarget).trigger(d.nss.event,[c])},Math.max(d.interval-J+d.timestamp,20));d.queue[q].push(e)}(c,h,a),a.height[q]=t,!0}e.countCallback++;++a.count&&b.data(w[0],a.nss.data_fired,a.id);!1===a.callback.apply(w[0],[c,h,{contaner:s[0],activator:l,selector:a.trigger,index:a.index,direction:a.direction,distance:a.distance,relations:a.root||a.extend?e.relations(a.nss.name):null,
