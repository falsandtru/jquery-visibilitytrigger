...
b.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$1")+"(?:$|.)"||"^$":"");case "undefined":case "null":case "0":case "boolean":case "false":var a,d;r=g.settings;for(var J=0;c=this[J];J++){switch(!0){case "object"!==typeof(a=k.data(c,"events")):case !a||"object"!==typeof(a=a[g.name]):continue}for(var m=0;d=a[m];m++)if("number"===typeof d.data||d.type===g.name)switch(c=d.data,b?typeof b:String(b)){case "number":if((e=r[c])&&c===b&&(p=n.call(this,e))!==s)return p;break;case "string":case "":if((e=r[c])&&h.test(d.namespace)&&
(p=n.call(this,e))!==s)return p;break;default:if((e=r[c])&&(p=n.call(this,e))!==s)return p}}if(f&&(p=n.call(this))!==s)return p}return this},redirect:function(b,n,f,r){var e,c,h,p;!b&&""!==b&&this.vtUID&&this instanceof k&&"string"===typeof this.vtNamespace&&(b=this.vtNamespace);switch(this instanceof k?b?typeof b:String(b):"direct:"+(b?typeof b:String(b))){case "direct:undefined":case "direct:boolean":case "direct:false":case "direct:null":case "direct:0":c=g.ids;n=g.settings;for(var a=1;b=c[a];a++)if((e=
n[b])&&(p=f.call(this,e))!==s)return p;if(r&&(p=f.call(this))!==s)return p;break;case "direct:number":case "number":n=g.settings;if((e=n[b])&&(p=f.call(this,e))!==s||r&&(p=f.call(this))!==s)return p;break;case "direct:string":case "direct:":c=g.ids;n=g.settings;b=b.split(".").sort().join(".");h=RegExp("string"===typeof b?b&&"(?:^|.)"+b.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$1")+"(?:$|.)"||"^$":"");for(a=1;b=c[a];a++)if((e=n[b])&&h.test(e.nss.name)&&(p=f.call(this,e))!==s)return p;if(r&&(p=f.call(this))!==
...
return r},registrate:function(b,g,f,r,e,c){var h,p,a;h=this;a=e.ids;p=e.settings;var d,k;d=b(g);k=b(f);k=d.add(k);[].slice.call(arguments);for(var m=0;2>m;m++)h=h[m]===g?h.not(g).add(f):h;for(var m=0,t,q;q=h[m];m++){t=b(q);if(c.terminate&&!t.find(c.trigger)[0])break;if(e.search.call(t[e.name](),c.nss.name,function(a){switch(a.reset&&typeof a.reset||a.reset){case "boolean":return this.release(a.nss.name),!0;case "object":return e.redirect.call(this,a.nss.name,!1,function(a){b.extend(!0,a,a.reset)}),
!1;default:return!1}})&&(c=b.extend(!0,{},c),c.id=p.length,c.context=q,a.push(c.id),p[c.id]=c,b.data(q,c.nss.data,c.id),(c.root||c.extend)&&e.relations(c.nss.name,q),!c.multi&&t.find(c.trigger).removeData(c.nss.data_fired),t.bind(c.nss.event,c.id,function(a,c,d){e.countEvent++;var h,m,k,p,q,t;h=e.settings[a.data];k=a;q=!0;if(h){switch(c&&typeof c||c){case "function":return t=c,m=d,!m&&k.stopPropagation(),(m||k.target===k.currentTarget)&&t.apply(b(this)[e.name](),[h].concat([].slice.call(arguments,
3)));case "object":m=c,q=!1;default:p=q?0===c?f:k.target:m.target,t=arguments.callee,k.stopPropagation()}b(h.trigger,p).first().is(":hidden")||function(a,c,d,l){switch(!0){case !e.settings[l.id]:case !l.status.active:case 3<l.queue.length:break;case l.id!==b.data(a.currentTarget,l.nss.data):b(a.currentTarget)[e.name]().release(l.id);break;default:if(q||!l.delay&&!l.interval){for(;h=l.queue.shift();)clearTimeout(h);e.countTask++;e.drive(b,g,f,r,e,a,c,d,l)}else{var h,k;for(k=l.interval?(new Date).getTime()-
l.timestamp:0;h=l.queue.shift();)clearTimeout(h);h=setTimeout(function(){for(;h=l.queue.shift();)clearTimeout(h);e.countTask++;e.drive(b,g,f,r,e,a,c,d,l)},Math.max(l.delay,l.interval-k,50));l.queue.push(h)}}}(k,m,p,h)}}),t.not(f).bind(c.nss.scroll,c.id,function(a){e.countRedirect++;var c=e.settings[a.data];c&&c.status.active&&b(a.currentTarget).trigger(c.nss.event,[a]);a.stopPropagation()}).bind(c.nss.resize,c.id,function(a){e.countRedirect++;var c=e.settings[a.data];c&&c.status.active&&b(a.currentTarget).trigger(c.nss.event,
[a]);a.stopPropagation()}),!(0<m))){var v=0;k.not(q).bind(c.nss.event,c.nss.event,function(a){e.countRedirect++;var c=a.data,d;if(a.target===g)b(f).trigger(c,[].slice.call(arguments,1));else if(a.currentTarget===f){var h=Number(Boolean(a.target!==a.currentTarget));d=[].slice.call(arguments,1);switch(typeof d[0]){case "function":d.push(h);break;case "undefind":d.push(h)}1>v&&(v++,e.relations(c.replace(/^\w+\.?/,"")).filter(h?a.target:"*").not(f).trigger(c,d),v--)}a.stopPropagation()});c.nss.alias&&
k.bind(c.nss.alias,c.nss.event,function(a){e.countRedirect++;var c=a.data;b(a.target).trigger(c,[].slice.call(arguments,1));a.stopPropagation()});(c.root||c.extend)&&d.bind(c.nss.scroll,c.nss.event,function(a){e.countRedirect++;var c=a.data;b(a.currentTarget).trigger(c,[a]);a.stopPropagation()}).bind(c.nss.resize,c.nss.event,function(a){e.countRedirect++;var c=a.data;b(a.currentTarget).trigger(c,[a]);a.stopPropagation()})}}},drive:function(b,g,f,k,e,c,h,p,a,d){e.countDrive++;var s,m,t,q,v,l,w,y,x,
u;d=d||{};s=d.context=d.update?d.context:b(c.currentTarget);m=d.eventcontext=d.update?d.eventcontext:b(p);d.root=d.update?d.root:!s.parent()[0];t=d.layer=d.update?d.layer:Number(Boolean(m.parent()[0]));l=v=q=!1;w=d.targets=d.update&&a.step?d.targets:s.find(a.trigger);w=d.targets=0<=a.index||w.length>a.index?d.targets:s.find(a.trigger);y=d.evtScroll=d.update?d.evtScroll:m.scrollTop();m=d.evtHeight=d.update?d.evtHeight:a.height[t];x=d.direction=d.update?d.direction:y===m?a.direction:y<m?-1:1;u=d.distance=
d.update?d.distance:Math.abs(y-m);m=w.eq(a.index);a.direction!==x&&(a.turn=!0,a.end=!1,a.direction=x,a.index=0>a.index?0:w.length<=a.index?w.length-1:a.index,m=w.eq(a.index));a.distance=0===u?a.distance:u;a.height[t]=y;switch(!0){case 0>a.index||w.length<=a.index:break;case !w.length||!m[0]:break;default:var z,A,C,D,E;l=d.$win=d.update?d.$win:b(g);v=d.winTop=d.update?d.winTop:l.scrollTop();l=d.winHeight=d.update?d.winHeight:l.height();y=v+l;var B,H,F,G;u=a.ahead[0];x=d.aheadTop=d.update?d.aheadTop:
"number"===typeof u?parseInt(u,10):parseInt(eval(l+u),10);u=a.ahead[1];B=d.aheadBottom=d.update?d.aheadBottom:"number"===typeof u?parseInt(u,10):parseInt(eval(l+u),10);H=d.beforehand=d.beforehand?d.beforehand:0>a.beforehand?w.length+a.beforehand+1:a.beforehand;z=s;a.root?(u=d.frameTop=d.update?d.frameTop:v,l=d.frameHeight=d.update?d.frameHeight:l):(u=d.frameTop=d.update?d.frameTop:parseInt(z.offset().top,10),l=d.frameHeight=d.update?d.frameHeight:z.outerHeight());z=u+l;D=d.visibleTop=d.update?d.visibleTop:
Math.max(u,v);E=d.visibleBottom=d.update?d.visibleBottom:Math.min(z,y);A=parseInt(m.offset().top,10);l=m.outerHeight();C=A+l;F=E>=A-B;G=D<=C+x;l=1===a.direction?F:G;switch(!0){case a.first&&H>a.index&&(a.multi||!b.data(m[0],a.nss.data_fired)):H>a.index&&(q=l=!0);break;case t?!1:D>z+B||E<u-x:l=1===a.direction?D>z&&z>A-B:E<u&&u<C+x;break;case !a.skip&&!a.multi:q=1===a.direction?F:G;break;case a.skip&&!a.multi:q=F&&G;break;case !a.skip&&a.multi:q=1===a.direction?F:G;a.first||h&&"resize"===h.type||(q=
1===a.direction?(t?E>A+a.distance-x:y>A+a.distance-x)?!1:q:(t?D<C-a.distance+B:v<C-a.distance+B)?!1:q);break;case a.skip&&a.multi:q=F&&G,a.first||h&&"resize"===h.type||(q=1===a.direction?(t?E>A+a.distance-x:y>A+a.distance-x)?!1:q:(t?D<C-a.distance+B:v<C-a.distance+B)?!1:q)}v=a.step?a.step*a.direction:q?-1===a.direction&&-1||0:a.direction;q&&!a.multi&&(q=m[0]&&b.data(m[0],a.nss.data_fired)?!1:q,q=a.turn&&!d.recursion?!1:q)}if(q){if(a.interval){var I=(new Date).getTime();if(a.interval<=I-a.timestamp)a.timestamp=
I;else return function(a,c,d){var e=setTimeout(function(){b(a.currentTarget).trigger(d.nss.event,[c])},Math.max(d.interval-I+d.timestamp,50));d.queue.push(e)}(c,h,a),!0}e.countCallback++;++a.count&&b.data(m[0],a.nss.data_fired,a.id);!1===a.callback.apply(m[0],[c,h,{contaner:s[0],activator:p,selector:a.trigger,index:a.index,direction:a.direction,distance:a.distance,relations:a.root||a.extend?e.relations(a.nss.name):null,parameter:a.parameter}])&&a.count--&&b.removeData(m[0],a.nss.data_fired)}if(a.terminate&&
(!w.length||!a.multi&&a.step&&a.count>=w.length))return s[e.name]().release(a.id),!0;a.index+=l?v:0;d.update=d.update||a.cache;d.recursion?l&&arguments.callee.apply(this,arguments):(d.recursion=!0,l&&arguments.callee.apply(this,[].slice.call(arguments).concat([d])));a.first=!1;a.turn=!1;d.recursion=!1;return!0},terminate:function(b){var n,f;f=b.context;n=k(f);k.removeData(f,b.nss.data);!b.multi&&n.find(b.trigger).removeData(b.nss.data_fired);n.unbind(b.nss.event).unbind(b.nss.scroll).unbind(b.nss.resize);
