...
n[b])&&(l=f.call(this,e))!==r)return l;if(q&&(l=f.call(this))!==r)return l;break;case "direct:number":case "number":n=g.settings;if((e=n[b])&&(l=f.call(this,e))!==r||q&&(l=f.call(this))!==r)return l;break;case "direct:string":case "direct:":c=g.ids;n=g.settings;b=b.split(".").sort().join(".");h=RegExp("string"===typeof b?b&&"(?:^|.)"+b.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$1")+"(?:$|.)"||"^$":"");for(a=0;b=c[a];a++)if((e=n[b])&&h.test(e.nss.name)&&(l=f.call(this,e))!==r)return l;if(q&&(l=f.call(this))!==
...
l,a,d){e.countDrive++;var r,t,s,p,w,m,x,v,y,A,B;d=d||{};r=d.context=d.update?d.context:b(c.currentTarget);t=d.eventcontext=d.update?d.eventcontext:b(l);d.root=d.update?d.root:!r.parent()[0];s=d.layer=d.update?d.layer:Number(Boolean(t.parent()[0]));m=w=p=!1;x=d.targets=d.update&&a.step?d.targets:r.find(a.trigger);x=d.targets=0<=a.index||x.length>a.index?d.targets:r.find(a.trigger);y=d.evtScroll=d.update?d.evtScroll:t.scrollTop();t=v=d.evtHeight=d.update?d.evtHeight:a.height[s];A=d.direction=d.update?
d.direction:y===v?a.direction:y<v?-1:1;B=d.distance=d.update?d.distance:Math.abs(y-v);v=x.eq(a.index);a.direction!==A&&(a.turn=!0,a.end=!1,a.direction=A,a.index=0>a.index?0:x.length<=a.index?x.length-1:a.index,v=x.eq(a.index));a.distance=0===B?a.distance:B;a.height[s]=y;switch(!0){case 0>a.index||x.length<=a.index:case !x.length||!v[0]:break;default:var z,u,C,F;y=d.$win=d.update?d.$win:b(g);w=d.winTop=d.update?d.winTop:y.scrollTop();z=d.winHeight=d.update?d.winHeight:y.height();y=w+z;var G,D,E;m=
a.ahead[0];A=d.aheadTop=d.update?d.aheadTop:"number"===typeof m?parseInt(m,10):parseInt(eval(z+m),10);m=a.ahead[1];B=d.aheadBottom=d.update?d.aheadBottom:"number"===typeof m?parseInt(m,10):parseInt(eval(z+m),10);G=d.beforehand=d.beforehand?d.beforehand:0>a.beforehand?x.length+a.beforehand+1:a.beforehand;u=r;a.root?(m=d.frameTop=d.update?d.frameTop:w,z=d.frameHeight=d.update?d.frameHeight:z):(m=d.frameTop=d.update?d.frameTop:parseInt(u.offset().top,10),z=d.frameHeight=d.update?d.frameHeight:u.outerHeight());
u=m+z;z=d.visibleTop=d.update?d.visibleTop:Math.max(m,w);F=d.visibleBottom=d.update?d.visibleBottom:Math.min(u,y);u=parseInt(v.offset().top,10);m=v.outerHeight();C=u+m;D=F>=u-B;E=z<=C+A;m=1===a.direction?D:E;switch(!0){case a.first&&G>a.index&&(a.multi||!b.data(v[0],a.nss.data_fired)):G>a.index&&(p=m=!0);break;case !a.skip&&!a.multi:p=1===a.direction?D:E;break;case a.skip&&!a.multi:p=D&&E;break;case !a.skip&&a.multi:p=1===a.direction?D:E;!p||a.first||h&&"resize"===h.type||(p=1===a.direction?(s?F>=
u+a.distance-B:y>=u+a.distance-B)?!1:p:(s?z<=C-a.distance+A:w<=C-a.distance+A)?!1:p);break;case a.skip&&a.multi:p=D&&E,!p||a.first||h&&"resize"===h.type||(p=1===a.direction?(s?F>=u+a.distance-B:y>=u+a.distance-B)?!1:p:(s?z<=C-a.distance+A:w<=C-a.distance+A)?!1:p)}w=a.step?a.step*a.direction:p?-1===a.direction&&-1||0:a.direction;p=p&&b.data(v[0],a.nss.data_fired)?!1:p}if(p){if(a.interval){var H=(new Date).getTime();if(a.interval<=H-a.timestamp)a.timestamp=H;else return function(a,c,d){var e=setTimeout(function(){b(a.currentTarget).trigger(d.nss.event,
