...
case f.id!==b.data(a.currentTarget,f.nss.data):b(a.currentTarget)[e.name]().release(f.id);break;default:e.drive(b,g,h,v,e,a,c,d,f)}},l,k,m),n||!f.delay)r=r(f);else if(3>f.queue.length){for(var u;u=f.queue.shift();)clearTimeout(u);u=setTimeout(function(){if(f){for(;u=f.queue.shift();)clearTimeout(u);e.countTask++;r=f&&r(f)}},Math.max(f.delay,50));f.queue.push(u)}}});k.not(h).bind(c.nss.scroll,c.id,function(a){e.countRedirect++;var c=e.settings[a.data];c&&c.status.active&&b(a.currentTarget).trigger(c.nss.event,
...
var c=a.data;b(a.currentTarget).trigger(c,[a]);a.stopPropagation()})}}}},drive:function(b,g,h,v,e,c,f,l,a,d){e.countDrive++;var w,m,r,k,t,n,p,s,A,B;d=d||{};w=d.context=d.update?d.context:b(c.currentTarget);m=d.eventcontext=d.update?d.eventcontext:b(l);root=d.root=d.update?d.root:!w.parent()[0];r=d.layer=d.update?d.layer:Number(Boolean(m.parent()[0]));n=t=k=!1;p=d.targets=d.update&&a.step?d.targets:w.find(a.trigger);p=d.targets=0<=a.index||p.length>a.index?d.targets:w.find(a.trigger);s=d.evtScroll=
d.update?d.evtScroll:m.scrollTop();m=d.evtHeight=d.update?d.evtHeight:a.height[r];A=d.direction=d.update?d.direction:s===m?a.direction:s<m?-1:1;B=d.distance=d.update?d.distance:Math.abs(s-m);m=p.eq(a.index);a.direction!==A&&(a.turn=!0,a.end=!1,a.direction=A,a.index=0>a.index?0:p.length<=a.index?p.length-1:a.index,m=p.eq(a.index));a.distance=0===B?a.distance:B;a.height[r]=s;switch(!0){case 0>a.index||p.length<=a.index:break;case !p.length||!m[0]:break;default:var y,x,z,C,D,E;n=d.$win=d.update?d.$win:
b(g);t=d.winTop=d.update?d.winTop:n.scrollTop();n=d.winHeight=d.update?d.winHeight:n.height();s=t+n;var u,F,G;x=Math.max(0,a.direction);A=d.aheadTop=d.update?d.aheadTop:-1<=a.ahead[0]&&1>=a.ahead[0]?parseInt(n*a.ahead[0],10):parseInt(a.ahead[0],10);B=d.aheadBottom=d.update?d.aheadBottom:-1<=a.ahead[1]&&1>=a.ahead[1]?parseInt(n*a.ahead[1],10):parseInt(a.ahead[1],10);u=x?B:A;y=w;a.root?(x=d.frameTop=d.update?d.frameTop:t,n=d.frameHeight=d.update?d.frameHeight:n):(x=d.frameTop=d.update?d.frameTop:parseInt(y.offset().top,
10),n=d.frameHeight=d.update?d.frameHeight:y.outerHeight());y=x+n;D=d.visibleTop=d.update?d.visibleTop:Math.max(x,t);E=d.visibleBottom=d.update?d.visibleBottom:Math.min(y,s);z=parseInt(m.offset().top,10);n=m.outerHeight();C=z+n;F=E>=z-B;G=D<=C+A;n=1===a.direction?F:G;switch(!0){case r?!1:D>y+u||E<x-u:n=1===a.direction?D>y&&y>=z-B:E<x&&x<=C+A;break;case a.first&&a.beforehand>a.index&&(a.multi||!b.data(m[0],a.nss.data_fired)):a.beforehand>a.index?k=n=!0:a.beforehand=0;break;case !a.skip&&!a.multi:k=
1===a.direction?F:G;break;case a.skip&&!a.multi:k=F&&G;break;case !a.skip&&a.multi:k=1===a.direction?F:G;a.first||f&&"resize"===f.type||(k=1===a.direction?(r?E>z+a.distance-u:s>z+a.distance-u)?!1:k:(r?D<C-a.distance+u:t<C-a.distance+u)?!1:k);break;case a.skip&&a.multi:k=F&&G,a.first||f&&"resize"===f.type||(k=1===a.direction?(r?E>z+a.distance-u:s>z+a.distance-u)?!1:k:(r?D<C-a.distance+u:t<C-a.distance+u)?!1:k)}t=a.step?a.step*a.direction:k?-1===a.direction&&-1||0:a.direction;k&&!a.multi&&(k=m[0]&&
