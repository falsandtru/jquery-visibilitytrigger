...
a.direction:a.step*a.direction,!a.end)return arguments.callee.apply(this,arguments)}if("function"===typeof this)return arguments.callee.apply(jQuery(g),arguments);var e=window.validator instanceof Object?window.validator:!1;(e=e?e.clone({name:"jquery.displaytrigger.js",base:!0}):e)&&e.start();e&&e.test("++",1,0,"displaytrigger()");var b=jQuery.extend(!0,{},{id:0,gns:"displaytrigger",ns:t,trigger:t,callback:function(){},parameter:[],ahead:0,beforehand:0,step:1,multi:!1,skip:!1,expand:!0,delay:300,
mode:"show",terminate:!0,reset:!0},n),d=[b.gns].concat(b.ns||[]);b.reset&&jQuery.extend(!0,b,{nss:{displaytrigger:d.join("."),scroll:["scroll"].concat(d.join(":")).join("."),resize:["resize"].concat(d.join(":")).join("."),data:d.join(":"),array:d},context:this,scope:this[0]===g?jQuery(v):jQuery(this),index:0,length:0,ahead:typeof b.ahead in{string:1,number:1}?[b.ahead,b.ahead]:b.ahead,count:0,height:{},direction:1,distance:0,turn:!1,end:!1,reset:!1,queue:[]});if(b.scope.length&&b.scope.find(b.trigger).length&&
