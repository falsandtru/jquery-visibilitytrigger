 ...
 */
(function(){function u(u){function w(c,a,b,e){var q=window,r=document,r=b===q?r:b,g=!1,h,n;h=jQuery(a.trigger,r);n=h.eq(a.index);var j=jQuery(e).scrollTop(),k=a.height[e===q?"window":"element"],d=j===k?a.direction:j<k?-1:1,k=Math.abs(j-k);a.direction!==d&&(a.turn=!0,a.end=!1,a.direction=d,a.index=0>a.index?0:h.length<=a.index?h.length-1:a.index,n=h.eq(a.index));a.distance=0===k?a.distance:k;a.height[e===q?"window":"element"]=j;a.end=n[0]?!1:a.end;-1===a.direction&&a.length<h.length&&(a.turn=!1,a.end=
...
parseInt(a.ahead[l]),m,p;switch(a.mode){case "border":g=k+(1===a.direction?-l:f+l);m=g>=j;p=g<=j+d;g=a.turn&&(1===a.direction?g-a.distance>j:g+a.distance<j+d)?!1:a.skip?m&&p:1===a.direction?m:p;break;case "toggle":break;case "hide":break;default:m=k>=j-f-l,p=k<=j+d+l,g=a.turn&&a.multi&&(1===a.direction?k-a.distance>j-f-l:k+a.distance<j+d+l)?!1:a.skip?m&&p:1===a.direction?m:p}}g&&(jQuery.data(n[0],a.nss.data+"-fired",!0),a.count+=1,a.callback.apply(n[0],[c,a.parameter,{index:a.index,length:h.length,
